...
export const VideoHighlights: React.FC = () => {
  ...
  const displayVideos = highlights; // Show all available highlights
              ...
              >
                ...
                <div className="relative aspect-video rounded-xl overflow-hidden bg-[#18181B] border border-[#333338] shadow-md group-hover:border-[#FF2B2B]/60 transition-all">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-10 h-10 rounded-full bg-[#DC2626] text-white flex items-center justify-center shadow-lg shadow-red-950/50 transform group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="text-left">
                  <h3 className="text-[11px] font-mono font-bold text-zinc-200 uppercase tracking-wide line-clamp-2 group-hover:text-[#FF2B2B] transition-colors leading-snug">
                    {video.title}
                  </h3>
            ...
            <div className="p-4 sm:p-6 bg-[#121214] overflow-y-auto">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                <div>
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white leading-tight">{activeVideo.title}</h3>
                ...
                <div className="flex gap-2 flex-shrink-0">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 text-white rounded-lg text-sm font-medium transition-colors cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-[#FF2B2B] hover:bg-[#FF2B2B]/90 text-white rounded-lg text-sm font-medium transition-colors cursor-pointer shadow-lg shadow-red-900/20"
                  >
